...
def get_gaze_ratio(gray,frame,eye_points, facial_landmarks):
...
def video_feed():
    def generate():
        ...
        while True:
            ...
            global frames, letter_index, blinking_frames, select_keyboard_menu, keyboard_selected, last_keyboard_selected, keyboard_selection_frames
            frames += 1
            ...
            for face in faces:
                ...
                if select_keyboard_menu is True:
                    ...
                    gaze_ratio_left_eye = get_gaze_ratio(gray,frame,[36, 37, 38, 39, 40, 41], landmarks)
                    gaze_ratio_right_eye = get_gaze_ratio(gray,frame,[42, 43, 44, 45, 46, 47], landmarks)
